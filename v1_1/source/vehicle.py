...
class Vehicle(BaseModel):
    '''! \deprecated Use of class should be omitted in favor to the new \'Asset\' class.
    ...
    def GetTransactions(vehicle_id: Union[UUID, List[UUID]]) -> List[Transaction]:
        '''! \deprecated Use of this static method should be omitted in favor of the non-static variant with the same name.
        Get all transactions associated to this vehicle's id.
        '''
        pass
